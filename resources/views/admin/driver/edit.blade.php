                ...
                <div class="container-fluid">
                    <div class="card card-outline mb-4"> <!--begin::Header-->
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Pengemudi</h3>
                        </div>

                        <!-- URL diarahkan ke route resource admin.driver.update dengan menyertakan ID driver -->
                        <form action="{{ route('admin.driver.update', $driver->id) }}" method="POST">
                            @csrf <!-- Keamanan token Laravel -->
                            @method('PUT') <!-- Wajib untuk proses Update/Route PUT di Laravel -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small class="form-text text-muted">Pastikan nomor telepon aktif dan valid untuk
                                            keperluan koordinasi.</small>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-warning">
                                    <i class="fas fa-save"></i> Perbarui Pengemudi
                                </button>
